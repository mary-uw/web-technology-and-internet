...
<li id="menu-item-8457" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-8457">
<a class="" href="logout">role of login user:<%=session.getAttribute("role") %></a></li>
...
<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-9837"><a href="Profile">Crud Operation</a>
